...
pip install -r "${CLAUDE_PLUGIN_ROOT}/skills/xray-method/scripts/requirements.txt"
# or
uv pip install -r "${CLAUDE_PLUGIN_ROOT}/skills/xray-method/scripts/requirements.txt"
```
...
```bash
# Python
python "${CLAUDE_PLUGIN_ROOT}/skills/xray-method/scripts/analyze_file.py" \
...
```bash
python "${CLAUDE_PLUGIN_ROOT}/skills/xray-method/scripts/ast_parser.py" src/services/auth.ts
```
...
```bash
python "${CLAUDE_PLUGIN_ROOT}/skills/xray-method/scripts/doc_review.py" scan \
...
```bash
python "${CLAUDE_PLUGIN_ROOT}/skills/xray-method/scripts/doc_review.py" validate-links \
  --path docs/ --fix
```
...
```bash
python "${CLAUDE_PLUGIN_ROOT}/skills/xray-method/scripts/doc_review.py" verify \
...
```bash
python "${CLAUDE_PLUGIN_ROOT}/skills/xray-method/scripts/doc_review.py" update-indexes \
...
```bash
python "${CLAUDE_PLUGIN_ROOT}/skills/xray-method/scripts/doc_review.py" full-maintenance \
...
```bash
python "${CLAUDE_PLUGIN_ROOT}/skills/xray-method/scripts/rewrite_comments.py" analyze \
  src/main.py --report
```
...
```bash
python "${CLAUDE_PLUGIN_ROOT}/skills/xray-method/scripts/rewrite_comments.py" scan \
...
```bash
python "${CLAUDE_PLUGIN_ROOT}/skills/xray-method/scripts/rewrite_comments.py" report \
...
```bash
python "${CLAUDE_PLUGIN_ROOT}/skills/xray-method/scripts/rewrite_comments.py" rewrite \
...
```bash
python "${CLAUDE_PLUGIN_ROOT}/skills/xray-method/scripts/rewrite_comments.py" standards
```
