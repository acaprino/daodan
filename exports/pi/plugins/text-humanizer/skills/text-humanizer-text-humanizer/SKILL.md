---
name: text-humanizer-text-humanizer
description: 'Editor for any language: detect the 24 catalogued patterns and fix them in place. TRIGGER WHEN: text sounds AI-generated and needs humanization, or the user asks to humanize prose/text. DO NOT TRIGGER WHEN: the task involves refactoring source code (use clean-code:clean-code instead).'
